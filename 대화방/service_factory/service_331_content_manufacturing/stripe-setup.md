# Stripe Payment Links Setup — Manufacturing Content Setup

Step-by-step guide to accepting payments for the Manufacturing Content Setup service.
...
### Product 1 — Content System Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Content System Setup`
3. **Description:** `Production-ready content system for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
