...
서비스 번호: 397
원본 ID: svc-402
rank / tier / score: 397 / B / 78
카테고리 / 니치: booking / 보험 설계사
...
## 오퍼
Cal.com 또는 로컬 도구를 활용해 보험 설계사의 예약 시스템 흐름을 세팅하고 운영 문서까지 납품한다.

## 고객 문제
견적과 첫 응답이 늦어 전환을 놓친다

## 첫 실행 기준
보험 설계사의 현재 업무 화면 1개와 샘플 데이터 10개를 받아 첫 MVP 범위를 고정한다.
