...
서비스 번호: 263
원본 ID: svc-375
rank / tier / score: 263 / B / 82
카테고리 / 니치: support / 마케팅 대행사
...
## 오퍼
Chatwoot 또는 로컬 도구를 활용해 마케팅 대행사의 고객상담 흐름을 세팅하고 운영 문서까지 납품한다.

## 고객 문제
월간 보고서를 만드는 데 시간이 오래 걸린다

## 첫 실행 기준
마케팅 대행사의 현재 업무 화면 1개와 샘플 데이터 10개를 받아 첫 MVP 범위를 고정한다.
