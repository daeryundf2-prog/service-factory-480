# 마케팅 대행사 고객상담 서비스 납품 체크리스트

## 사전 준비
- 사용자 소유 결제 계정에서 Ko-fi Payments 링크를 발급한다.
...
- Apple Pay for real-world services: accountRequired=true; 디지털 기능 판매에는 IAP가 필요할 수 있다.
