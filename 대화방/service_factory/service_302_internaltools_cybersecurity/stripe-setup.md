# Stripe Payment Links Setup — Cybersecurity Internaltools Setup

Step-by-step guide to accepting payments for the Cybersecurity Internaltools Setup service.
...
### Product 1 — Internal Tool Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Internal Tool Setup`
3. **Description:** `Production-ready internal tool for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$449` (one-time)
5. Save.
...
2. Create link for Product 1 ($449 one-time).
