# Cybersecurity Finance Setup

**Financial Dashboard setup for CyberSecurity.**
...
| Item | Price |
|------|-------|
| One-time setup (all deliverables above) | $599 |
| Monthly maintenance (optional) | $199/month |
...
7 days of post-delivery support is included. Monthly maintenance available at $199/month after the support window.
...
3. We start building your financial dashboard the same day.
