# Stripe Payment Links Setup — Manufacturing Automation Setup

Step-by-step guide to accepting payments for the Manufacturing Automation Setup service.
...
### Product 1 — Automation System Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Automation System Setup`
3. **Description:** `Production-ready automation workflow for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$499` (one-time)
5. Save.
...
2. Create link for Product 1 ($499 one-time).
3. Create link for Product 2 ($149/month recurring).
4. Copy both URLs.
