# Stripe Payment Links Setup — Manufacturing Knowledge Setup

Step-by-step guide to accepting payments for the Manufacturing Knowledge Setup service.
...
### Product 1 — Knowledge Base Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Knowledge Base Setup`
3. **Description:** `Production-ready knowledge base for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$299` (one-time)
5. Save.
...
2. Create link for Product 1 ($299 one-time).
3. Create link for Product 2 ($79/month recurring).
4. Copy both URLs.
