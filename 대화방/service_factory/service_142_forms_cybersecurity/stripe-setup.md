# Stripe Payment Links Setup — Cybersecurity Forms Setup

Step-by-step guide to accepting payments for the Cybersecurity Forms Setup service.
...
### Product 1 — Form Solution Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Form Solution Setup`
3. **Description:** `Production-ready form solution for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$249` (one-time)
5. Save.
...
2. Create link for Product 1 ($249 one-time).
3. Create link for Product 2 ($69/month recurring).
4. Copy both URLs.
