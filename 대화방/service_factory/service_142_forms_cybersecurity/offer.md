# Cybersecurity Forms Setup

**Form Solution setup for CyberSecurity.**
...
**Full Formbricks Dashboard (8+ charts)**
...
| Item | Price |
|------|-------|
| One-time setup (all deliverables above) | $249 |
| Monthly maintenance (optional) | $69/month |
...
7 days of post-delivery support is included. Monthly maintenance available at $69/month after the support window.
...
3. We start building your form solution the same day.
