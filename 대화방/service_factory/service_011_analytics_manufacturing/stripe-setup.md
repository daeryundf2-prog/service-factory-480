# Stripe Payment Links Setup — Manufacturing Analytics Setup

Step-by-step guide to accepting payments for the Manufacturing Analytics Setup service.
...
### Product 1 — Analytics Dashboard Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Analytics Dashboard Setup`
3. **Description:** `Production-ready analytics dashboard for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$399` (one-time)
5. Save.
...
2. Create link for Product 1 ($399 one-time).
3. Create link for Product 2 ($99/month recurring).
4. Copy both URLs.
