# Stripe Payment Links Setup — Manufacturing Commerce Setup

Step-by-step guide to accepting payments for the Manufacturing Commerce Setup service.
...
### Product 1 — Commerce Setup Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Commerce Setup Setup`
3. **Description:** `Production-ready commerce setup for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
