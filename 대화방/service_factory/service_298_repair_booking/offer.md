...
서비스 번호: 298
원본 ID: svc-174
rank / tier / score: 298 / B / 81
카테고리 / 니치: booking / 수리 업체
...
## 오퍼
Cal.com 또는 로컬 도구를 활용해 수리 업체의 예약 시스템 흐름을 세팅하고 운영 문서까지 납품한다.

## 고객 문제
반복 CS 답변을 매번 새로 작성한다

## 첫 실행 기준
수리 업체의 현재 업무 화면 1개와 샘플 데이터 10개를 받아 첫 MVP 범위를 고정한다.
