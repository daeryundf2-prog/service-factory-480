# Stripe Payment Links Setup — Manufacturing Crm Setup

Step-by-step guide to accepting payments for the Manufacturing Crm Setup service.
...
### Product 1 — CRM System Setup

1. Go to **Products** > **Add product**.
2. **Name:** `CRM System Setup`
3. **Description:** `Production-ready CRM system for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
