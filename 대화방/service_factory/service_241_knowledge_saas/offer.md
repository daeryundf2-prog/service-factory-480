# Saas Knowledge Setup

**Knowledge Base setup for SaaS.**
...
**Full Notion Dashboard (8+ charts)**
...
| Item | Price |
|------|-------|
| One-time setup (all deliverables above) | $299 |
| Monthly maintenance (optional) | $79/month |
...
7 days of post-delivery support is included. Monthly maintenance available at $79/month after the support window.
...
3. We start building your knowledge base the same day.
