# Stripe Payment Links Setup — Manufacturing Booking Setup

Step-by-step guide to accepting payments for the Manufacturing Booking Setup service.
...
### Product 1 — Booking System Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Booking System Setup`
3. **Description:** `Production-ready booking system for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
