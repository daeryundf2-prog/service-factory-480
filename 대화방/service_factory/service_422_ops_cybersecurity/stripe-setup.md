# Stripe Payment Links Setup — Cybersecurity Ops Setup

Step-by-step guide to accepting payments for the Cybersecurity Ops Setup service.
...
### Product 1 — Operations Dashboard Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Operations Dashboard Setup`
3. **Description:** `Production-ready operations dashboard for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
