# Stripe Payment Links Setup — Cybersecurity Support Setup

Step-by-step guide to accepting payments for the Cybersecurity Support Setup service.
...
### Product 1 — Support System Setup

1. Go to **Products** > **Add product**.
2. **Name:** `Support System Setup`
3. **Description:** `Production-ready support system for your business. Includes KPI discovery, event tracking, 8+ charts, and documentation.`
4. **Price:** `$349` (one-time)
5. Save.
...
2. Create link for Product 1 ($349 one-time).
