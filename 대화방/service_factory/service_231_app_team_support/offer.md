...
서비스 번호: 231
원본 ID: svc-363
rank / tier / score: 231 / B / 83
카테고리 / 니치: support / 앱 개발팀
...
## 오퍼
Chatwoot 또는 로컬 도구를 활용해 앱 개발팀의 고객상담 흐름을 세팅하고 운영 문서까지 납품한다.

## 고객 문제
고객 상태를 엑셀로 관리해 다음 액션이 보이지 않는다

## 첫 실행 기준
앱 개발팀의 현재 업무 화면 1개와 샘플 데이터 10개를 받아 첫 MVP 범위를 고정한다.
